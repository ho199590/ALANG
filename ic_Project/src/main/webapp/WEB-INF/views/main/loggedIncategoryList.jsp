					...
					<div class="row mb-5">
						<div class="col">
							<nav aria-label="breadcrumb">
							  <ol class="breadcrumb">
							    <li class="breadcrumb-item"><a href="./loggedIn.do">전체보기</a></li>
							    <li class="breadcrumb-item"><a href="./loggedInBigcategoryList.do?bigcategory_no=${getBigCategorybySmallCate.big_category_no}"> ${getBigCategorybySmallCate.big_category_name}</a></li>
							    <li class="breadcrumb-item active" aria-current="page"><a href="./loggedIncategoryList.do?smallcategory_no=${getoneSmallCategory.small_category_no}">${getoneSmallCategory.small_Category_Name}</a></li>
							  </ol>
							</nav>					
						</div>
						...
						<div class="row">
							<c:forEach items="${getCourseListBySmallCate}" var="list" varStatus="i">
