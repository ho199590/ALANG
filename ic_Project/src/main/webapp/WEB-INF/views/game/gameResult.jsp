		...
		<div class="container">
         ...
         로그인 회원만 요청 가능합니다. <a href="../member/loginPage.do">로그인페이지</a>
					...
					<hr class="new1">
						...
						<p>시작 시간 : <fmt:formatDate value="${gamedata.gameVo.game_start_time }" pattern="yyyy년 MM월 dd일 HH시 mm분 ss초"/></p>
						<p>종료 시간 : <fmt:formatDate value="${gamedata.gameVo.game_end_time }" pattern="yyyy년 MM월 dd일 HH시 mm분 ss초"/></p>
						<hr class="new1">
					<p class="title_size">${gamedata.gameVo.game_no }회차 당첨자</p>
						
					<c:forEach items="${gameresultdata }" var="data">
						<td>당첨자 :&nbsp; ${data.secondWinnerInfo.member_id } &nbsp;</td>
						</tr>
					</c:forEach>					
