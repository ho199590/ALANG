...
<div style="width: 1200px; margin: 0 auto">
		<div class="container">
			<div class="row">
				...
				<div class="col-10">
					<div class="row mt-5">
						<div class="col fs-1 fw-bold text-left">이벤트 관리자 페이지</div>
					</div>
	...
	<c:forEach items="${gamelist }" var="data">
						<tr onClick = "location.href='./adminGameDetailPage.do?game_no=${data.gameVo.game_no }'">				
	...
	<a href = "../game/gameMake.do">이벤트 개설하기</a>
</div>
<div class="col"></div>
</div>
</div>
